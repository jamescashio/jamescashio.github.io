...
def check_site_release(release: dict, failures: list[str], *, preview: bool = False, version: str = "37.13.0") -> None:
...
def main() -> int:
    ...
    version = "37.13.0-preview.sanctuary" if preview else "37.13.0"
    failures: list[str] = []
