...
def check_site_release(release: dict, failures: list[str], *, preview: bool = False, version: str = "37.7.0") -> None:
...
def main() -> int:
    ...
    version = "37.7.0-preview.parallax" if preview else "37.7.0"
    failures: list[str] = []
