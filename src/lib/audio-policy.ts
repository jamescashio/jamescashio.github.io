export type AirframeAudioTrigger = "pip" | "lineage" | "first-gesture" | "scroll" | "deck-nav" | "tour";

export const DEFAULT_AUDIO_ENABLED = false;

export const AIRFRAME_SAMPLE_NAMES = ["x1", "sr71", "proteus", "starship", "epstein", "warp", "fold", "p51"] as const;
