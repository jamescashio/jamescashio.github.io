...
export const LANES = [
  ...
  { id: "03A", name: "MULTIMODAL", model: "Gemini 3.6 Flash", tid: "", use: "Images, screenshots, diagrams. Eyes on the problem." },
  { id: "03B", name: "ADVERSARIAL", model: "Grok 4.5", tid: "", use: "Stress-test the answer. Argue with it until it holds." },
