...
export const PROJECTS = [
  ...
  },
  {
    ...
    subtitle: "Know when automation should stop.",
    category: "Bounded autonomy",
    cue: "Raise the consequence or lower the confidence. Watch the handoff.",
    color: "#b4c8e2",
  },
  {
    id: "exposure",
    ...
    cue: "Change reachability and authentication. See what needs investigation.",
    color: "#efab92",
  },
  {
    id: "briefing",
    title: "Sovereign Briefing",
    subtitle: "A useful brief keeps the unknowns.",
    category: "Decision intelligence",
    cue: "Include the routing record. See how the brief handles missing evidence.",
    color: "#d4c3a2",
  },
  {
    id: "dashboards",
  ...
  },
  {
    ...
    subtitle: "Find the signal worth acting on.",
    category: "Industrial intelligence",
    cue: "Set deviation to 30%. Add corroboration. Compare the next action.",
    color: "#e3c66f",
  },
  {
    id: "graphify",
    ...
    cue: "Select Policy, then Adapter. Compare the modules a change could affect.",
    color: "#bdb9e6",
  },
] as const;
