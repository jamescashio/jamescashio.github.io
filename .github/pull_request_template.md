...
- [ ] `public/site-release.json`, `package.json`, `CHANGELOG.md`, `RELEASE_BODY.md`, and the homepage agree on the software release; both `status.json` files separately preserve their dated evidence identity.
