...
## 2024-05-18 - [Hardcoded API Key Prevention]
**Vulnerability:** Found hardcoded `LITELLM_KEY` in `scripts/zeusapollo_swarm.py`.
**Learning:** Hardcoding API keys exposes them in source control, which can lead to unauthorized access or abuse of cloud resources.
**Prevention:** Always load secrets via environment variables or securely stored local configuration files, avoiding committing any sensitive data to the codebase.
